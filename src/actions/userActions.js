...
export const updateUserProfilePicture = (formData) => async (dispatch, getState) => {
    try {
        dispatch({
...
export const updateUserPasswordProfile = (oldPassword, newPassword) => async (dispatch, getState) => {
    try {
        dispatch({
