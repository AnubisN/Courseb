          ...
          <div className={classes.container}>
            ...
            <div className={classes.container__img__cover}>
              <Container>
                <div className={classes.course__container}>
                  <h2 className={classes.course__container__title}>
                    {course.name}
                  </h2>
                  ...
                  <p className={classes.course__container__price}>
                    {"Rs. " + course.price}
                  </p>
                  <button
                    className={
                      course.isAvailable
                        ? classes.button__primary__body
                        : classes.button__disabled__body
                    }
                    onClick={() => onLinkClick(course._id, course.isAvailable)}
                  >
                    {course.isAvailable ? "Enroll Now" : "Not Available"}
                  </button>
                </div>
              </Container>
            </div>
            ...
            <Container>
              <div className={classes.course__content}>
                <h2 className={classes.course__content__title}>
                  Course Description
                </h2>
              ...
              <div className={classes.course__content}>
                ...
                <div className={classes.course__instructor}>
                  ...
                  <div className={classes.course__instructor__details}>
                    <p className={classes.course__instructor__details__name}>
                      {instructor.first_name + " " + instructor.last_name}
                    </p>
                    <p className={classes.course__instructor__details__status}>
                      {instructor.job}
                    </p>
                  </div>
                </div>
              ...
              <div className={classes.course__content}>
                ...
                <div className={classes.course__review__section}>
                  <Button className={classes.button} type="secondary">
                    More Reviews
                  </Button>
                </div>
              </div>
